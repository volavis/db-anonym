...
public class ByteAttribute extends Attribute {
     ...
     */
    public ByteAttribute(Attribute attribute) {
        super(attribute, JavaDataType.BYTE, GuiID.INTEGER);
    }
    ...
    public Object getConstValue() {
        ...
        byte tmpByte = optionData.getBigIntegerValue().byteValue();
        return isSigned() ? tmpByte : String.valueOf(tmpByte);
    }
    ...
    public Object getRndValue(Map<AnonymizationDataID, Object> additionalDataMap) {
        ...
        byte tmpByte = tmpBigInteger.byteValue();
        return isSigned() ? tmpByte : String.valueOf(tmpByte);
    }
}